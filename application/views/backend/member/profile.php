<div class="row" data-appear-animation="fadeInRight" data-appear-animation-delay="100">
    <?php echo form_open(base_url() . 'index.php?burial/manage_system/do_update' , 
    ...
    <div class="col-lg-6">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
          ...
          <p class="text-muted mb-0">Your member details</p>
        </div>
        <div class="card-body p-4">
          <dl class="row mb-0">
            <dt class="col-sm-4 text-muted">Full Name</dt>
            <dd class="col-sm-8"><?php echo htmlspecialchars($this->session->userdata('name')); ?></dd>

            <dt class="col-sm-4 text-muted">Passbook No</dt>
            <dd class="col-sm-8"><?php echo htmlspecialchars($this->session->userdata('passbook_no')); ?></dd>

            <dt class="col-sm-4 text-muted">National ID</dt>
            <dd class="col-sm-8"><?php echo htmlspecialchars($this->session->userdata('idnumber')); ?></dd>

            <dt class="col-sm-4 text-muted">Cell</dt>
            <dd class="col-sm-8"><?php echo htmlspecialchars($this->session->userdata('cellnumber')); ?></dd>

            <dt class="col-sm-4 text-muted">Policy Status</dt>
    ...
    <div class="col-lg-6">
      <div class="card border-0 shadow-sm h-100">
        <div class="card-header bg-white border-0 pt-4 px-4 pb-0">
          ...
          <p class="text-muted mb-0">Placeholder settings</p>
        </div>
        <div class="card-body p-4">
          <div class="alert alert-info mb-3">
            Profile edits will be enabled once verification and approval workflows are connected.
          </div>
          <ul class="list-group list-group-flush">
            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
              Notifications <span class="badge bg-primary">Email & SMS</span>
            </li>
            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
              Language <span class="badge bg-secondary">English</span>
            </li>
            <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
              Statement Delivery <span class="badge bg-secondary">Monthly</span>
            </li>
          </ul>
        </div>
      </div>
